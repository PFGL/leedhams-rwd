			<footer class="footer" role="contentinfo">
				...
				<div id="inner-footer" class="wrapper">
                    ...
                    <div class="subsidary-statement">
                        <a href="http://www.pfgl.co.uk"><img src="<?php echo get_template_directory_uri(); ?>/library/images/perspective-logo-small.png" alt="<?php bloginfo('name'); ?>" class="alignleft"></a>
